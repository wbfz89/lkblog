	...
	if($action_key == ''){
		...
		if($post_type == 'page'){
			...
			if(is_post_type_viewable($post_type)){
				$fields['thumbnail']	= ['title'=>'缩略图',	'type'=>'view',	'column_callback'=>'wpjam_get_admin_post_list_thumbnail'];
				$fields['views']		= ['title'=>'浏览',		'type'=>'view',	'column_callback'=>'wpjam_get_admin_post_list_views',	'sortable_column'=>'meta_value_num'];
