...
add_action('update_option_wpjam-basic', function($old_value, $value){
	wpjam_basic_option_updated($value);
}, 10, 2);

add_action('add_option_wpjam-basic', function($option, $value){
	wpjam_basic_option_updated($value);
}, 10, 2);

function wpjam_basic_option_updated($value){
