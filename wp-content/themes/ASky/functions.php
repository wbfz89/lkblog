...
function get_the_link_items($id = null){
  ...
  if ( !empty($bookmarks) ) {
      ...
      foreach ($bookmarks as $bookmark) {
		...
		<img class="linksimage" src="'. $bookmark->link_url.'/favicon.ico" alt="" onerror="javascript:this.src=\'' . $default_ico . '\'" /><span class="sitename">'. $bookmark->link_name .'</span><div class="linkdes">'. ''. $bookmark->link_description .'</div></a></li>';
      }
      $output .= '</ul>';
  }
  return $output;
