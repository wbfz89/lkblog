			...
			<header class="site-header" role="banner">
				<div class="site-top">
					<div class="site-branding">
						...
						<div  id="tiaodan" class="site-logo"><a href="<?php bloginfo('url');?>"><img  src="<?php echo akina_option('akina_logo'); ?>" alt="<?php bloginfo('name');?>"></a>
						</div>
						<?php }else{ ?>
						<h1 id="tiaodan" class="site-title"><a href="<?php bloginfo('url');?>" ><?php bloginfo('name');?></a></h1>
						<?php } ?>
						<!-- logo end -->
					</div>
					<!-- .site-branding -->
