...
.author-profile i , .post-like a , .post-share .show-share , .sub-text , .we-info a , span.sitename , .post-more i:hover , #pagination a:hover , .post-content a:hover , .float-content i:hover,.entry-content a:hover , .site-info a:hover , .comment h4 a ,  .comment h4 a:hover , .site-top ul li a:hover , .entry-title a:hover , #archives-temp h3 , span.page-numbers.current , .sorry li a:hover , .site-title a:hover , i.iconfont.icon-search:hover , .comment-respond input[type='submit']:hover ,.loginwords a { color: <?php echo akina_option('theme_skin'); //填充颜色和主题保持一致?> }
	
.feature i , .foverlay , .download , .navigator i:hover ,.comment .isauthor, .links ul li:before , .ar-time i , span.ar-circle , .object , .comment .comment-reply-link ,.siren-checkbox-radio:checked + .siren-checkbox-radioInput:after,::-webkit-scrollbar-thumb ,.comment-respond input[type='submit'],#readprogress, .post-share p, #add_post span,a.page-numbers { background: <?php echo akina_option('theme_skin'); //背景色和主题一致 ?> }
