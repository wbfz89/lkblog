...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			...
			printf(esc_html__( '%1$s &nbsp; %2$s &nbsp; %3$s &nbsp; %4$s', 'akina' ), $site_map_link, '<a href="http://lkblog.cc/" target="_blank" rel="nofollow">LkBlog</a>', '<a href="http://skyarea.cn/archives/466" rel="designer" target="_blank" rel="nofollow">Theme</a>', '<a href="https://wordpress.org/" target="_blank" rel="nofollow">WordPress</a>', $statistics_link); 
			?>
            <!--显示网站已运行多长时间-->
	...
	?>
           <div class="footer-device">
            ...
            <SCRIPT language=javascript>
				...
				span_dt_dt.innerHTML="龙鲲博客已成功存活了："+daysold+"天"+hrsold+"小时"+minsold+"分"+seconds+"秒";
				}
				show_date_time();
				</SCRIPT>
			</div>
